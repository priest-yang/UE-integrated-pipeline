...
//         std::cout << features.User_speed_X << std::endl;
//     }
...
// int main() {
//     std::string filePath = "/home/shaoze/Documents/Boeing/UE-integrated-pipeline/data/demo/feature_fam/0.csv";
...
int main() {
    ...
    FiniteAutomationMachine model;  // Assumes default initial state is ErrorState
