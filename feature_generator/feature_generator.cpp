...
bool possible_interaction_helper(const Features& row, double COLLISION_THRESHOLD) {
    ...
    // TODO: Shawn, you have to ensure that the speeds are signed. In my implementation, speeds were always the magnitudes 
    // and velocities were signed
    ...
    // TODO: It is unlikely to ever be exactly zero. We can maybe set a threshold below which there is no interaction, and above which we
...
vector<Features> generate_wait_time(vector<Features>& rows, double H1 = 0.2, double H2 = 0.1, double THRESHOLD_ANGLE = 30, double frame_rate = 30) {
    ...
    for (size_t index = 0; index < rows.size(); ++index) {
        ...
        // TODO: Should you be setting the wait time to zero in this case?
        if (AGV_passed_Flag) {
            continue;
        }
        ...
        // TODO: This is wrong. the function above returns the acos (the actual angle) and you are comparing it with the cosine of the threshold angle
        // Compute cosine of the angles returned above and then compare
